...
def add_or_modify_item( sku_id, item_name, buy_price, sell_price, quantity):
...
def display_existing_item( item):
...
if st.button("Add/Modify Item"):
    add_or_modify_item(sku_id, item_name, buy_price, sell_price, quantity)
